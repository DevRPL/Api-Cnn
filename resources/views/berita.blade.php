...
<html lang="{{ config('app.locale') }}">
    ...
    <div id="appendDivNews">
        <nav class="navbar fixed-top navbar-light bg-faded" style="background-color: #e3f2fd;">
          <a class="navbar-brand" href="#">Berita Seluruh Dunia</a>
        </nav>

            {{ csrf_field() }}
    <section id="content" class="section-dropdown">
    <p class="select-header"> Pilih sumber berita: </p>
    <label class="select"> 
        ...
        <article>
            ...
            <div class="text">
                ...
                @if($selected_news['publishedAt'] != null)
                 <div style="padding-top: 5px;">Tanggal Diterbitkan: {{ Carbon\Carbon::parse($selected_news['publishedAt'])->format('l jS \\of F Y ') }}</div>
                 @else
                 <div style="padding-top: 5px;">Tidak Diketahui</div>
